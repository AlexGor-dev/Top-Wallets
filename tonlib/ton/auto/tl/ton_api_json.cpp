...
Result<int32> tl_constructor_from_string(ton_api::Object *object, const std::string &str) {
  static const std::unordered_map<Slice, int32, SliceHash> m = {
    ...
    {"storage.daemon.fileInfo", 1498170004},
    ...
    {"storage.daemon.torrent", 1691225670},
...
Result<int32> tl_constructor_from_string(ton_api::Function *object, const std::string &str) {
  static const std::unordered_map<Slice, int32, SliceHash> m = {
    ...
    {"storage.daemon.addByHash", -1979569116},
    {"storage.daemon.addByMeta", 1950065644},
    {"storage.daemon.closeStorageContract", -159929584},
    {"storage.daemon.createTorrent", -1878193046},
    ...
    {"storage.daemon.getTorrentFull", 1600365636},
    {"storage.daemon.getTorrentMeta", 974235919},
    {"storage.daemon.getTorrentPeers", -923195702},
    {"storage.daemon.getTorrents", -2051621035},
    {"storage.daemon.importPrivateKey", 2147449850},
    {"storage.daemon.initProvider", 673143500},
    {"storage.daemon.loadFrom", -1970900276},
