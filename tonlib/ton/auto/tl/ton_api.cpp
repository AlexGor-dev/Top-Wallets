...
storage_daemon_fileInfo::storage_daemon_fileInfo(std::string const &name_, std::int64_t size_, std::int32_t priority_, std::int64_t downloaded_size_)
  : name_(std::move(name_))
  , size_(size_)
  , priority_(priority_)
  , downloaded_size_(downloaded_size_)
...
object_ptr<storage_daemon_fileInfo> storage_daemon_fileInfo::fetch(td::TlParser &p) {
  return make_object<storage_daemon_fileInfo>(p);
}

storage_daemon_fileInfo::storage_daemon_fileInfo(td::TlParser &p)
#define FAIL(error) p.set_error(error)
  : name_(TlFetchString<std::string>::parse(p))
...
object_ptr<storage_db_torrent> storage_db_torrent::fetch(td::TlParser &p) {
...
storage_daemon_addByHash::storage_daemon_addByHash(td::Bits256 const &hash_, std::string const &root_dir_, bool start_download_, bool allow_upload_, std::vector<object_ptr<storage_PriorityAction>> &&priorities_)
  : hash_(hash_)
  , root_dir_(std::move(root_dir_))
...
object_ptr<storage_daemon_addByHash> storage_daemon_addByHash::fetch(td::TlParser &p) {
  return make_object<storage_daemon_addByHash>(p);
}

storage_daemon_addByHash::storage_daemon_addByHash(td::TlParser &p)
#define FAIL(error) p.set_error(error)
  : hash_(TlFetchInt256::parse(p))
  , root_dir_(TlFetchString<std::string>::parse(p))
  , start_download_(TlFetchBool::parse(p))
  , allow_upload_(TlFetchBool::parse(p))
  , priorities_(TlFetchVector<TlFetchObject<storage_PriorityAction>>::parse(p))
#undef FAIL
{}

void storage_daemon_addByHash::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  s.store_binary(-1979569116);
  TlStoreBinary::store(hash_, s);
  TlStoreString::store(root_dir_, s);
...
storage_daemon_addByMeta::storage_daemon_addByMeta(td::BufferSlice &&meta_, std::string const &root_dir_, bool start_download_, bool allow_upload_, std::vector<object_ptr<storage_PriorityAction>> &&priorities_)
  : meta_(std::move(meta_))
  , root_dir_(std::move(root_dir_))
  , start_download_(start_download_)
  , allow_upload_(allow_upload_)
...
object_ptr<storage_daemon_addByMeta> storage_daemon_addByMeta::fetch(td::TlParser &p) {
  return make_object<storage_daemon_addByMeta>(p);
}

storage_daemon_addByMeta::storage_daemon_addByMeta(td::TlParser &p)
#define FAIL(error) p.set_error(error)
  : meta_(TlFetchBytes<td::BufferSlice>::parse(p))
  , root_dir_(TlFetchString<std::string>::parse(p))
  , start_download_(TlFetchBool::parse(p))
...
storage_daemon_createTorrent::storage_daemon_createTorrent(std::string const &path_, std::string const &description_, bool allow_upload_, bool copy_inside_)
...
object_ptr<storage_daemon_createTorrent> storage_daemon_createTorrent::fetch(td::TlParser &p) {
  return make_object<storage_daemon_createTorrent>(p);
}

storage_daemon_createTorrent::storage_daemon_createTorrent(td::TlParser &p)
#define FAIL(error) p.set_error(error)
  : path_(TlFetchString<std::string>::parse(p))
  , description_(TlFetchString<std::string>::parse(p))
  , allow_upload_(TlFetchBool::parse(p))
  , copy_inside_(TlFetchBool::parse(p))
#undef FAIL
{}

void storage_daemon_createTorrent::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  s.store_binary(-1878193046);
...
storage_daemon_getTorrentFull::storage_daemon_getTorrentFull(td::Bits256 const &hash_)
  : hash_(hash_)
{}
...
object_ptr<storage_daemon_getTorrentFull> storage_daemon_getTorrentFull::fetch(td::TlParser &p) {
  return make_object<storage_daemon_getTorrentFull>(p);
}

storage_daemon_getTorrentFull::storage_daemon_getTorrentFull(td::TlParser &p)
#define FAIL(error) p.set_error(error)
  : hash_(TlFetchInt256::parse(p))
#undef FAIL
{}
...
storage_daemon_getTorrentMeta::storage_daemon_getTorrentMeta(td::Bits256 const &hash_)
  : hash_(hash_)
{}
...
object_ptr<storage_daemon_getTorrentMeta> storage_daemon_getTorrentMeta::fetch(td::TlParser &p) {
  return make_object<storage_daemon_getTorrentMeta>(p);
}

storage_daemon_getTorrentMeta::storage_daemon_getTorrentMeta(td::TlParser &p)
#define FAIL(error) p.set_error(error)
  : hash_(TlFetchInt256::parse(p))
#undef FAIL
{}
...
storage_daemon_getTorrentPeers::storage_daemon_getTorrentPeers(td::Bits256 const &hash_)
  : hash_(hash_)
{}
...
object_ptr<storage_daemon_getTorrentPeers> storage_daemon_getTorrentPeers::fetch(td::TlParser &p) {
  return make_object<storage_daemon_getTorrentPeers>(p);
}

storage_daemon_getTorrentPeers::storage_daemon_getTorrentPeers(td::TlParser &p)
#define FAIL(error) p.set_error(error)
  : hash_(TlFetchInt256::parse(p))
#undef FAIL
{}
...
object_ptr<storage_daemon_getTorrents> storage_daemon_getTorrents::fetch(td::TlParser &p) {
  return make_object<storage_daemon_getTorrents>(p);
}

storage_daemon_getTorrents::storage_daemon_getTorrents(td::TlParser &p)
#define FAIL(error) p.set_error(error)
#undef FAIL
{
  (void)p;
...
storage_daemon_loadFrom::storage_daemon_loadFrom(td::Bits256 const &hash_, td::BufferSlice &&meta_, std::string const &path_)
  : hash_(hash_)
  , meta_(std::move(meta_))
  , path_(std::move(path_))
{}
...
object_ptr<storage_daemon_loadFrom> storage_daemon_loadFrom::fetch(td::TlParser &p) {
  return make_object<storage_daemon_loadFrom>(p);
}

storage_daemon_loadFrom::storage_daemon_loadFrom(td::TlParser &p)
#define FAIL(error) p.set_error(error)
  : hash_(TlFetchInt256::parse(p))
  , meta_(TlFetchBytes<td::BufferSlice>::parse(p))
  , path_(TlFetchString<std::string>::parse(p))
...
#define FAIL(error) p.set_error(error); return ReturnType()
  return TlFetchBoxed<TlFetchObject<storage_daemon_torrent>, 1691225670>::parse(p);
#undef FAIL
}
