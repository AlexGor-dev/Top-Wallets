...
class storage_daemon_fileInfo final : public Object {
 public:
  ...
  storage_daemon_fileInfo(std::string const &name_, std::int64_t size_, std::int32_t priority_, std::int64_t downloaded_size_);

  static const std::int32_t ID = 1498170004;
  std::int32_t get_id() const final {
    return ID;
  }
  ...
  explicit storage_daemon_fileInfo(td::TlParser &p);
...
class storage_daemon_torrent final : public Object {
 public:
  ...
  static const std::int32_t ID = 1691225670;
  std::int32_t get_id() const final {
    return ID;
  }
...
class storage_db_torrent final : public Object {
 public:
  std::string root_dir_;
  bool active_download_;
  bool active_upload_;
  ...
  static object_ptr<storage_db_torrent> fetch(td::TlParser &p);
...
class storage_daemon_addByHash final : public Function {
 public:
  ...
  storage_daemon_addByHash(td::Bits256 const &hash_, std::string const &root_dir_, bool start_download_, bool allow_upload_, std::vector<object_ptr<storage_PriorityAction>> &&priorities_);

  static const std::int32_t ID = -1979569116;
  std::int32_t get_id() const final {
    return ID;
  }
  ...
  explicit storage_daemon_addByHash(td::TlParser &p);
...
class storage_daemon_addByMeta final : public Function {
 public:
  ...
  storage_daemon_addByMeta(td::BufferSlice &&meta_, std::string const &root_dir_, bool start_download_, bool allow_upload_, std::vector<object_ptr<storage_PriorityAction>> &&priorities_);

  static const std::int32_t ID = 1950065644;
  std::int32_t get_id() const final {
    return ID;
  }
  ...
  explicit storage_daemon_addByMeta(td::TlParser &p);
...
class storage_daemon_createTorrent final : public Function {
 public:
  ...
  storage_daemon_createTorrent(std::string const &path_, std::string const &description_, bool allow_upload_, bool copy_inside_);

  static const std::int32_t ID = -1878193046;
  std::int32_t get_id() const final {
    return ID;
  }
  ...
  explicit storage_daemon_createTorrent(td::TlParser &p);
...
class storage_daemon_getTorrentFull final : public Function {
 public:
  ...
  explicit storage_daemon_getTorrentFull(td::Bits256 const &hash_);

  static const std::int32_t ID = 1600365636;
  std::int32_t get_id() const final {
    return ID;
  }
  ...
  explicit storage_daemon_getTorrentFull(td::TlParser &p);
...
class storage_daemon_getTorrentMeta final : public Function {
 public:
  ...
  explicit storage_daemon_getTorrentMeta(td::Bits256 const &hash_);

  static const std::int32_t ID = 974235919;
  std::int32_t get_id() const final {
    return ID;
  }
  ...
  explicit storage_daemon_getTorrentMeta(td::TlParser &p);
...
class storage_daemon_getTorrentPeers final : public Function {
 public:
  ...
  explicit storage_daemon_getTorrentPeers(td::Bits256 const &hash_);

  static const std::int32_t ID = -923195702;
  std::int32_t get_id() const final {
    return ID;
  }
  ...
  explicit storage_daemon_getTorrentPeers(td::TlParser &p);
...
class storage_daemon_getTorrents final : public Function {
 public:
  ...
  static const std::int32_t ID = -2051621035;
  std::int32_t get_id() const final {
    return ID;
  }
  ...
  explicit storage_daemon_getTorrents(td::TlParser &p);
...
class storage_daemon_loadFrom final : public Function {
 public:
  ...
  storage_daemon_loadFrom(td::Bits256 const &hash_, td::BufferSlice &&meta_, std::string const &path_);

  static const std::int32_t ID = -1970900276;
  std::int32_t get_id() const final {
    return ID;
  }
  ...
  explicit storage_daemon_loadFrom(td::TlParser &p);
