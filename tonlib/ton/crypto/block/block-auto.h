...
struct ConfigParam final : TLB_Complex {
  ...
  struct Record_cons80 {
    typedef ConfigParam type_class;
    Ref<CellSlice> x;  	// JettonBridgeParams
    Record_cons80() = default;
    Record_cons80(Ref<CellSlice> _x) : x(std::move(_x)) {}
  };
  ...
  bool unpack(vm::CellSlice& cs, Record_cons80& data) const;
  bool unpack_cons80(vm::CellSlice& cs, Ref<CellSlice>& x) const;
  bool cell_unpack(Ref<vm::Cell> cell_ref, Record_cons80& data) const;
  bool cell_unpack_cons80(Ref<vm::Cell> cell_ref, Ref<CellSlice>& x) const;
  bool pack(vm::CellBuilder& cb, const Record_cons80& data) const;
  bool pack_cons80(vm::CellBuilder& cb, Ref<CellSlice> x) const;
  bool cell_pack(Ref<vm::Cell>& cell_ref, const Record_cons80& data) const;
  bool cell_pack_cons80(Ref<vm::Cell>& cell_ref, Ref<CellSlice> x) const;
...
extern const RefT t_Ref_TYPE_1615;
// HASH_UPDATE Account
...
extern const RefT t_Ref_TYPE_1627;
...
extern const RefT t_Ref_TYPE_1641;
// ^McStateExtra
...
extern const RefT t_Ref_TYPE_1671;
// ^SignedCertificate
...
extern const RefT t_Ref_TYPE_1679;
...
extern const RefT t_Ref_TYPE_1725;
// HashmapE 256 ^Cell
