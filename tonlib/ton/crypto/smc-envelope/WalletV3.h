...
namespace ton
{
    ...
    public:
        ...
        static td::Ref<vm::Cell> get_init_data(const td::Ed25519::PublicKey& public_key, td::uint32 wallet_id, td::uint32 seqno = 0) noexcept;
...
namespace ton
{
    ...
    public:
        ...
        static WalletType get_code_type()
        {
    ...
    struct RestrictedWalletTraits
    {
        ...
        static constexpr unsigned max_message_size = vm::CellString::max_bytes;
        static constexpr unsigned max_gifts_size = 4;
        static constexpr auto code_type = WalletType::RestrictedWallet;
    };
