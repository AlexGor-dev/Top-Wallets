...
namespace Complex.Ton
{
    ...
    public class JettonInfo : IUnique
    {
        ...
        public JettonInfo(string name, string description, string symbol, string image_data, UInt128 totalSupply, int decimals, string jettonAddress, string ownerAddress, string color, string deployer)
            :this(name, description, symbol, image_data, new Balance(symbol, totalSupply, decimals, 3), decimals, jettonAddress, ownerAddress, color, deployer)
        {
        ...
        {
            Images.LoadImage(image_data, ImageID, "jetton.svg", 96, 16, resultHandler);
        }
        ...
        public static JettonInfo FromDict(Dict<string> dict, string jtonAddress, string owner, UInt128 totalSupply)
        {
            ...
            return new JettonInfo(dict["name"], dict["description"], symbol, dict.Contains("image") ? dict["image"] : dict["image_data"], totalSupply, decimals, jtonAddress, owner, dict["color"], dict["deployer"]);
        }
